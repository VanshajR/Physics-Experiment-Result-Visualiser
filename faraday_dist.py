...
import numpy as np
from tkinter import *
print("FARADAY'S LAW(CONSTANT DISTANCE)")
n=int(input("Enter number of readings:"))
emf_list=[]
time_list=[]
angle_list=[]
d=int(input("Enter the constant distance taken:"))
print()
...
for i in range(0,n):
    ...
    time_list.append(t)
print()
print("Enter the readings of angle below:-")
for i in range(0,n):
    print("Enter",i+1,"th reading of angle:")
    a=float(input())
    a2=(a/2)*(math.pi/180)
...
vel_list=[]
for i in range(0,n):
    v=((4*math.pi)/time_list[i])*d*math.sin(angle_list[i])
    vel_list.append(v)
